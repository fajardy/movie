 ...
 */
public class Movie_Now_Playing extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_movie__now__playing, container, false);
        recyclerView = (RecyclerView) view.findViewById(R.id.Recyclerview_movie_now_playing);
        refreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.refreshlayout_movie_now_playing);
        fr = ((Frag_Movies)Movie_Now_Playing.this.getParentFragment());
    ...
    public void requestdata(){
        ...
        Call<ResponeModel> res = api.Now_Playing_Movie(getContext().getResources().getString(R.string.API_KEY));
